...
thisP.makeGrid = function() {
    ...
    var tbody = utilsdomjs_create( "TBODY" );
    this.dom  = utilsdomjs_create( "TABLE", null, tbody );
    this.grid = [];
...
var exported_Board = Board;
export { exported_Board as Board };
