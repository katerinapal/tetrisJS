...
import {
    addHandler as utilseventsjs_addHandler,
    removeHandler as utilseventsjs_removeHandler,
...
function TetrisGame( args ) {
    this.dom       = utilsdomjs_create("div");
...
thisP.makeHTML = function () {
    ...
    this.msgText = utilsdomjs_create("string", "");
    var msgColor  = this.playBoard.color == [255,255,255] ? [0, 0, 0] : [255, 255, 255]; 
    var msgDiv    = utilsdomjs_create("div",
    ...
    var layout  = utilsdomjs_create("div", null,
            utilsdomjs_create("TBODY", null,
                utilsdomjs_create("TR", null,
                        utilsdomjs_create("TD", null, this.score.dom),
                        utilsdomjs_create("TD")
                ),
                utilsdomjs_create("TR", null,
                        utilsdomjs_create("TD", null, 
                                utilsdomjs_create("div", { style : "position : relative" },
                                        msgDiv,
                                        this.playBoard.dom)
                        ),
                        utilsdomjs_create("TD",
                                {style : "padding-left : 10px; vertical-align:top ;" },
                                utilsdomjs_create("string", "Preview"),
...
thisP.startKbdHandler = function () {
    var self = this;
    this.kbdDnHandle = utilseventsjs_addHandler(document, "keydown", function ( event ) {
...
thisP.stopKbdHandler = function () {
    if ( this.kbdDnHandle !== null ) {
        utilseventsjs_removeHandler(this.kbdDnHandle);
    }
};
