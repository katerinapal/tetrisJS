...
import { mod_shapeTemplates as shapeTemplates } from ".\\shapeTemplates.js";
import { addHandler as events_addHandler, removeHandler as events_removeHandler } from "..\\utils\\events.js";
...
thisP.makeHTML = function () {
    ...
    var layout  = dom_create("div", null,
            dom_create("TBODY", null,
                dom_create("TR", null,
                        dom_create("TD", null, this.score.dom),
                        dom_create("TD")
                ),
                dom_create("TR", null,
                        dom_create("TD", null, 
                                dom_create("div", { style : "position : relative" },
                                        msgDiv,
                                        this.playBoard.dom)
                        ),
                        dom_create("TD",
                                {style : "padding-left : 10px; vertical-align:top ;" },
                                dom_create("string", "Preview"),
...
thisP.startKbdHandler = function () {
    var self = this;
    this.kbdDnHandle = events_addHandler(document, "keydown", function ( event ) {
...
thisP.stopKbdHandler = function () {
    if ( this.kbdDnHandle !== null ) {
        events_removeHandler(this.kbdDnHandle);
    }
};
...
var mod_TetrisGame = TetrisGame;
export { mod_TetrisGame as TetrisGame };
export { PLAYING };
export { PAUSED };
export { CLEARING };
