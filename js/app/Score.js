...
function Score( game ) {
    ...
    this.level = 1;
    this.score = 0;
    this.scoreStr = dom_create("string", this.score);
    this.levelStr = dom_create("string", this.level);
    this.dom   = dom_create("div", { style : "overflow : auto;"},
            dom_create("div", { style : "overflow : auto;" },
                    dom_create("div", { style : "float : left;"}, "Level : "),
                    dom_create("div", { style : "float : right; text-align : right"},
                            this.levelStr)
            ),
            dom_create("div", { style : "overflow : auto;" },
                    dom_create("div", { style : "float : left;"}, "Score : "),
                    dom_create("div", { style : "float : right; text-align : right"},
                            this.scoreStr)
            )                        
    );
