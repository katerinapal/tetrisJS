...
var events_obj_addHandler = function (dom, type, handler) {
    function wrapHandler(event) {
        handler(handleBrowserDiffs(event || window.event));
    }
    registerHandler(dom, type, wrapHandler);
...
var events_obj_removeHandler = function (object) {
    if ( object != null ) {
        unregisterHandler(object.dom, object.type, object.handler);
    }
};

export { events_obj_addHandler as addHandler, events_obj_removeHandler as removeHandler };