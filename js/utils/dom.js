...
var exported_self_create;
var exported_self_setAttributes;
var exported_self_setAttribute;
var self = {};
/*
 * method - setAttribute
 * lets the attribute be specified as the HTML attribute name instead of the JS property.
 */
exported_self_setAttribute = function (obj, attr, value) {
    if ( attr === "class" ) {
        obj.className = value;
    }
...
exported_self_setAttributes = function ( obj, attributes ) {
    if (!attributes) { return; }
    _.each(attributes,
            function (value, attr) {
                exported_self_setAttribute(obj, attr, value);
            }
    );
};
 ...
 */
exported_self_create = function( type, attributes ) {
    var obj;
    if (type === "string") {
        ...
        exported_self_setAttributes(obj, attributes);
...
function addKids ( parent ) {
    for (var i=1; i<arguments.length; i++) {
        ...
        if ( typeof child === "string" ) {
            child = exported_self_create('string', child);
        }
...
export { exported_self_create as create };
